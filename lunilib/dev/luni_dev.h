...
#elif defined(_M_ARM)
#define __c_write win_arm_write
#define __c_read win_arm_read
#elif defined(_M_ARM64)
#define __c_write win_arm64_write
#define __c_read win_arm64_read
#else
...
#define __c_write linux_riscv64_write
#define __c_read linux_riscv64_read
#elif defined(__powerpc64__)
#define __c_write linux_powerpc64_write
#define __c_read linux_powerpc64_read
#else
...
#define __c_write apple_arm64_write
#define __c_read apple_arm64_read
#else
